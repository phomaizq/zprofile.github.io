...
/* Gmail: nguyentinhoaian@gmail.com  */
/*----------------------------------*/
...
{background:#f1f1f1;border-radius:50px}
...
html
{
    position:relative;overflow-x:hidden!important;overflow-x:hidden!important
}
*
...
body
{
    font-family:'Quicksand',sans-serif;color:#324e63;margin:0
}
a,a:hover
{
...
<a href="https://www.instagram.com/phomai.zq/" class="profile-card-social__item instagram" target="_blank">
<span class="icon-font">
...
<path d="M256,352V32h64c0,32,64,96,128,96v64c-64,0-128-32-128-32V352c0,128-128,128-128,128S64,480,64,352,192,224,192,224c32,0,40,10,40,10v64s-8-10-40-10c0,0-64,0-64,64s64,64,64,64S256,416,256,352Z"/>
</symbol>
